  ...
  public async generateRecommendations(
    ...
    try {
      ...
      const shouldGenerate =
        await this.shouldGenerateNewRecommendation(farmerId);
      ...
      if (!activeCrop) {
        const recommendation: Recommendation = {
          ...
          message:
            "Please set up your farm profile first to receive irrigation recommendations.",
          recommendation:
      ...
      const recommendation: Recommendation = {
        ...
        priority:
          irrigationNeed.confidence === "high"
            ? 4
            : irrigationNeed.confidence === "medium"
              ? 3
              : 2,
...
export const irrigationRecommendationModule =
  new IrrigationRecommendationModule();
