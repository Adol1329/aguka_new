...
export const soilApi = {
  ...
  getCurrentStatus: () => apiClient.get<SoilStatus>("/soil/status"),

  getAlerts: () => apiClient.get<ApiResponse>("/soil/alerts"),

  getRecommendations: () => apiClient.get<ApiResponse>("/soil/recommendations"),
